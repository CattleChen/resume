$(function(){
  ...
  (function(){
    var startY,lineAmin,outClass,inClass,current=0,
        ...
        scrollNext=true,
        $currentPage=null;
    function nextPage(index){isScroll=false;
    ...
    function prePage(index){isScroll=false;
      ...
      function animationInSecondPage(element){
        ...
        $avatar.on(
          "webkitAnimationEnd animationend",
          function(){$(this).off("webkitAnimationEnd animationend")}
        )
      }
      ...
      function animationInFourPage(element){
        ...
        $firstChild.addClass("in");element.find(".type div:first-child").addClass("rotate90").next().addClass("reverse-rotate90")}
      function animationInFivePage(element){
        var pElem=element.find("p");var imgHead=element.find(".smallHead1");imgHead.addClass("imgMoveFromLeft");
